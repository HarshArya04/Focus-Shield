...
// --- NEW: Get unique status elements ---
const activeStatusText = document.getElementById("active-status");
const setupStatusText = document.getElementById("setup-status"); // We don't really use this one, but it's good to have
...
function updateUI(isEnabled, endTime) {
    ...
    if (isEnabled) {
        ...
        if (endTime) {
            ...
            activeStatusText.classList.add("hidden"); // Hide the "Focus is ON" text
            ...
            activeStatusText.classList.remove("hidden"); // SHOW the "Focus is ON" text
        ...
        // No need to do anything, the "setup-view" is already correct
    }
}
